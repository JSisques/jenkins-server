...
# Paso 5: Ejecutar Docker Compose para iniciar el servidor de Jenkins
echo "Paso 5: Iniciando el servidor de Jenkins con Docker Compose..."
docker-compose up -d
echo "El servidor de Jenkins se está ejecutando en segundo plano."